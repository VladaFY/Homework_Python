...
Задание аналогично заданию 2.5, но в реализации следует максимально широко использовать генераторы.
...
2. Для формирования отчета необходимо максимально широко использовать генераторы и (или) итераторы
